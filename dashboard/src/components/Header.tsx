...
import { Snowflake, RefreshCw, Menu, X, LayoutGrid, Map, Bell, Settings, BarChart3 } from 'lucide-react';
...
export default function Header({ lastUpdated, activeView = 'dashboard', onViewChange }: HeaderProps) {
